...
gravity_unit_vector_ecef = gravity_vector/gravity_vector.norm()
...
# the quaternion if we're sitting on the north pole
...
pprint(init_rot_err_cov.xreplace({accel_vector[0]: 1, accel_vector[1]: 0, accel_vector[2]: -1, yaw_angle: math.radians(90), accel_sigma:0.1, yaw_sigma: 1, gravity_vector[0]: 0, gravity_vector[1]: 0, gravity_vector[2]:9.80655}).evalf())
